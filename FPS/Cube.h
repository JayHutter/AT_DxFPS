...
public:
	...
	static IndexedTriangleList<V> MakeIndependentTextured()
	{
		...
		itl.vertices[8].tc = { 1.0f,1.0f };
		itl.vertices[9].tc = { 1.0f,0.0f };
		itl.vertices[10].tc = { 0.0f,1.0f };
		itl.vertices[11].tc = { 0.0f,0.0f };
		itl.vertices[12].tc = { 0.0f,1.0f };
		itl.vertices[13].tc = { 0.0f,0.0f };
		itl.vertices[14].tc = { 1.0f,1.0f };
		itl.vertices[15].tc = { 1.0f,0.0f };
